...
export default class Form4server extends Component {
    constructor() {
        super()
        this.state = {
            person: {
    ...
    updateuser=()=>{
        ...
        axios({
            method:'put',
            url:'http://localhost:3003/form4/'+number,
            data:this.state.person
        })
    ...
    deleteuser=(user ,id)=>{
        ...
        console.log(number);
        console.log(user , id);
        axios.delete("http://localhost:3003/form4/"+number).then((res)=>{
        ...
        return (
            <div className='container'>
                <div className='Username'>
                    ...
                    <input type="text" id='uname' className='form-control' name='username' placeholder='id' value={this.state.person.id} onChange={(e)=>{this.CheckingInput(e)}}/><br />
                </div>
    ...
    async componentDidMount(){
        let callingusers = await axios.get('http://localhost:3003/form4/')
