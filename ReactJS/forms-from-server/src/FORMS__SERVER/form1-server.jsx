...
export default class Form1 extends Component {
    ...
    deleteuser=(usr ,id)=>{       
        var number= id + 1
        console.log(usr ,id);
        axios.delete("http://localhost:3002/form1/"+number).then((res)=>{
    ...
    updateUser=()=>{
        ...
        axios({
            method:'put',
            url:'http://localhost:3002/form1/'+number,
            data: this.state.person
        })
    ...
    async componentDidMount() {
        var serverdata = await axios.get("http://localhost:3002/form1/")
